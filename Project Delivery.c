...
void store_registration_number(struct Student_reg_num reg[],int n)
{ //function to store registration number
    int i;
...
void Student__address(struct Student_address adds[],int n)
{  
//storing Student home address//
    int i;
...
void difference(struct Student_address adds[],struct mailing_adress Madds[],int n)
{   
//to set mailing address similar to student address
int i;
for(i=0;i<n;i++)
{
...
int R,E;
int total_grade;
char AAAA[]="A+",AAA[]="A",AA[]="A-";
char BBBB[]="B+",BBB[]="B",BB[]="B-";
char CCCC[]="C+",CCC[]="C",CC[]="C-";
char DDDD[]="D+",DDD[]="D",DD[]="D-";
char F[]="F";
